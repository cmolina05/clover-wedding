...
import { _ as Circle, a as OptionsColor, d as OptionLoader, f as loadOptions, h as OutMode, i as AnimatableColor, l as loadProperty, m as ParticleOutType, r as ValueWithRandom, s as loadLazyProperty, t as ParticlesBounce, u as loadRangeProperty, v as Rectangle } from "./ParticlesBounce-U9xxjyXm.js";
import { c as getStyleFromRgb, d as rangeColorToHsl, f as rangeColorToRgb, i as getHslFromAnimation, s as getStyleFromHsl, t as alterHsl } from "./ColorUtils-Dx0i-BbJ.js";
...
var Move = class extends OptionLoader {
	...
	doLoad(data) {
		...
		if (outModes !== void 0) {
			if (isObject(outModes)) this.outModes.load(outModes);
...
var ParticlesOptions = class extends OptionLoader {
	...
	doLoad(data) {
		...
		if (paintToLoad) {
			if (isArray(paintToLoad)) this.paint = executeOnSingleOrMultiple(paintToLoad, (t) => {
				const tmp = new Paint();
				tmp.load(t);
				return tmp;
			});

    ...
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 pt-28 pb-24 w-full max-w-4xl mx-auto">
        ...
        <div style={anim('0.4s')}>
          ...
          {/* ── Ampersand with letter-spacing animation ── */}
            ...
            <>
              <div className="grid grid-cols-4 gap-3 max-w-sm mx-auto">
                {[
                  ...
                  <div key={item.label} className="flex flex-col items-center py-4 px-2 rounded-sm countdown-glow"
        ...
        <div style={anim('1.05s')}>
          <a href="#rsvp" id="hero-rsvp-btn"
            className="btn-shimmer rsvp-pulse inline-block px-14 py-4 text-[11px] tracking-[0.22em] uppercase font-sans text-white transition-all duration-500"

...
import "./browser-B-P830vV.js";
import { _ as Circle, a as OptionsColor, c as loadOptionProperty, g as AnimationMode, h as OutMode, i as AnimatableColor, l as loadProperty, m as ParticleOutType, n as RangedAnimationValueWithRandom, o as RangedAnimationOptions, p as StartValueType, r as ValueWithRandom, t as ParticlesBounce, u as loadRangeProperty, v as Rectangle } from "./ParticlesBounce-U9xxjyXm.js";
import { t as RotateDirection } from "./RotateDirection-D96AavKe.js";
import { a as getLinkColor, c as getStyleFromRgb, d as rangeColorToHsl, h as AnimationStatus, l as hslToRgb, m as updateColor, n as colorMix, o as getLinkRandomColor, p as rgbToHsl, r as getHslAnimationFromHsl, s as getStyleFromHsl, u as hslaToRgba } from "./ColorUtils-Dx0i-BbJ.js";
import { d as Interactivity, i as mouseMoveEvent, p as DivType, u as InteractorType } from "./InteractivityConstants-Cc-qpWot.js";
...
var BlendPlugin = class {
	...
	async getPlugin(container) {
		const { BlendPluginInstance } = await import("./BlendPluginInstance-B-bStAI3.js");
...
var MovePlugin = class {
	...
	async getPlugin(container) {
		const { MovePluginInstance } = await import("./MovePluginInstance-D2eneG_0.js");
...
function checkDestroy(particle, destroyType, value, minValue, maxValue) {
	switch (destroyType) {
		case DestroyType.max:
			...
			break;
		case DestroyType.min: if (value <= minValue) particle.destroy();
	}
}
	...
	if (animationOptions.enable) {
		...
		switch (animationOptions.mode) {
			...
			case AnimationMode.decrease:
				...
				break;
			case AnimationMode.random: res.status = getRandom() >= .5 ? AnimationStatus.increasing : AnimationStatus.decreasing;
		}
...
function updateAnimation(particle, data, changeDirection, destroyType, delta) {
	...
	switch (data.status) {
		case AnimationStatus.increasing:
			data.value += velocity;
			break;
		case AnimationStatus.decreasing: data.value -= velocity;
	}
...
var InteractivityPlugin = class {
	...
	async getPlugin(container) {
		const { InteractivityPluginInstance } = await import("./InteractivityPluginInstance-D1Ml-E2w.js");
...
var Pusher = class extends ExternalInteractorBase {
	...
	constructor(container) {
		...
		this.handleClickMode = (mode, interactivityData) => {
			...
			const group = itemFromArray([void 0, ...pushOptions.groups]), groupOptions = group !== void 0 ? container.actualOptions.particles.groups[group] : void 0, particlesOptions = itemFromSingleOrMultiple(pushOptions.particles), overrideOptions = deepExtend(groupOptions, particlesOptions);
...
function resolveCollision(p1, p2, delta, pixelRatio) {
	...
	switch (p1.options.collisions.mode) {
		...
		case CollisionMode.bounce:
			bounce(p1, p2);
			break;
		case CollisionMode.destroy: destroy(p1, p2);
	}
}
//#endregion
...
var OverlapPlugin = class {
	id = "overlap";
	async getPlugin(container) {
		const { OverlapPluginInstance } = await import("./OverlapPluginInstance-C9F-ZHqs.js");
...
var LinksPlugin = class {
	...
	async getPlugin(container) {
		const { LinkInstance } = await import("./LinkInstance-CMk7Z39u.js");
	...
	init(particle) {
		...
		switch (rotateDirection) {
			...
			case "counterClockwise":
				...
				break;
			case RotateDirection.clockwise: particle.rotate.status = AnimationStatus.increasing;
		}

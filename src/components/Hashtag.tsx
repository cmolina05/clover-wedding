  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(circle at 1px 1px, #B8CDD7 1px, transparent 0)`,
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        ...
        <div className="reveal mb-12">
          ...
          <h2 className="font-serif text-4xl md:text-5xl mb-4" style={{ fontWeight: 300, letterSpacing: '0.05em', color: '#EBF4F7' }}>
            Use Our Hashtag
          </h2>
        ...
        <div className="reveal">
          ...
          {/* Hashtag display */}
          <div
            className="inline-block border rounded-sm px-10 py-5 mb-8 transition-all duration-300 hover:scale-105 cursor-pointer group"
            style={{
              borderColor: 'rgba(184,205,215,0.3)',
          ...
          <div>
            <button
              ...
              className="inline-flex items-center gap-3 border py-4 px-10 text-[10px] tracking-[0.2em] uppercase font-sans transition-all duration-400 hover:bg-wedding-white hover:text-dusty-blue-dark"
              style={{
                borderColor: 'rgba(184,205,215,0.4)',
                color: '#EBF4F7',
              }}
            >

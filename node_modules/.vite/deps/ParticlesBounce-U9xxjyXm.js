...
var OptionsColor = class OptionsColor extends OptionLoader {
	...
	static create(source, data) {
		...
		color.load(source);
		if (data !== void 0) {
			if (isString(data) || isArray(data)) color.load({ value: data });
...
var AnimatableColor = class AnimatableColor extends OptionsColor {
	...
	doLoad(data) {
		...
		if (colorAnimation !== void 0) {
			if (colorAnimation.enable === void 0) this.animation.load(data.animation);
